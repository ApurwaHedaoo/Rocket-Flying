...
function createGoldbar(){
  if(World.frameCount%80 == 0){
    var goldbar = createSprite(Math.round(random(50,300),40,10,10))
...
function createGoldcoin(){
  if(World.frameCount%50 == 0) {
    var goldcoin = createSprite(Math.round(random(50,300),40,10,10));
...
function createStar(){
  if(World.frameCount%24 == 0) {
    var star = createSprite(Math.round(random(50,300),40,10,10));
...
function createBomb(){
  if(World.frameCount%24 == 0){
    var bomb = createSprite(Math.round(random(50,300),40,10,10));
